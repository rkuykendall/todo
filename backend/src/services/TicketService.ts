 ...
 * This class is designed to be testable by accepting a database dependency.
 */
export class TicketService {
   ...
   */
  private selectTicketsForDraw(
    todayDay: string,
    existingTicketIds: Set<string>
  ): RawDbTicket[] {
    const today = getTodayDate();
    const maxDrawCount = calculateDailyDrawCount(this.db);
